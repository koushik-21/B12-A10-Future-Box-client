...
const MyExports = () => {
  ...
  return (
    <div className="p-4 min-h-screen bg-gray-50">
      ...
      {/* Update Modal */}
      {selectedProduct && (
        <div className="fixed inset-0 bg-black bg-opacity-25 flex justify-center items-center z-50 p-4 overflow-y-auto">
          <div className="bg-white p-6 rounded-2xl w-full max-w-md shadow-lg flex flex-col overflow-y-auto max-h-[90vh]">
            ...
            <form onSubmit={handleUpdateSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col">
                <label className="mb-1 font-semibold">Product Image URL</label>
                <input
                  type="text"
                  name="productImage"
              ...
              <div className="flex flex-col">
                <label className="mb-1 font-semibold">Available Quantity</label>
                <input
                  type="number"
